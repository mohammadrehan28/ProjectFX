    ...
    public void handleClicksItems(MouseEvent mouseEvent) {
        ...
        try {
            ...
            for (int i = 0; i < datadepartment.size(); i++) {
                ...
                ItemController.SetData(datadepartment.get(i).get(1).toString(), datadepartment.get(i).get(6).toString(), datadepartment.get(i).get(3).toString(), datadepartment.get(i).get(7).toString(), ava, true,datadepartment.get(i).get(0).toString());
                if (column == 2) {
                    column = 0;
                    row++;
                }
